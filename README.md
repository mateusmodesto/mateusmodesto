...
- Python para automações, extração e tratamento de dados  
- SQL (Oracle e SQL Server)  
- Integração com APIs  
- Desenvolvimento de relatórios e processos automatizados  
- Versionamento com Git e GitHub  
- Conceitos e práticas da área de dados  
